...
/**
 * This class implements the ObjectiveStrategy and represents the strategy for the objective "TOP_LEFT_L_SHAPE".
 * It calculates the points of the player based on the number of top left L shapes
...
public class TopLeftLShape implements ObjectiveStrategy {
    ...
    /**
     * The color of the card that's at the top left of the L shape
     */
    private final CardColorEnum diagonalCardColor;

    /**
     * The number of points that the player gets for each top left L shapes of the specified color in their card matrix
     */
     ...
     * @param diagonalCardColor the color of the card that's at the top left of the L shape
     * @param pointsPerPattern the number of points that the player gets for each top left L shapes
     *                         of the specified color in their card matrix
     */
    ...
    /**
     * This method calculates the points of the player based on the number of top left L shapes
     *      of the specified color in their card matrix
     * @param player the player whose points are being calculated
     * @return the points of the player based on the number of top left L shapes
     *      of the specified color in their card matrix
     */
    ...
    /**
     * This method returns the number of points that the player gets for each top left L shapes
     *      of the specified color in their card matrix
     * @return the number of points that the player gets for each top left L shapes of the specified color in their card matrix
     */
