...
public enum GoldStrategyType {
    ...
    OBJECT_COUNT_INKWELL(new ObjectCount(2, ObjectTypeEnum.INKWELL)),
    OBJECT_COUNT_MANUSCRIPT(new ObjectCount(2, ObjectTypeEnum.MANUSCRIPT)),
    OBJECT_COUNT_QUILL(new ObjectCount(2, ObjectTypeEnum.QUILL)),
